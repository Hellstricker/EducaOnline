...
using EducaOnline.Financeiro.Pagamentos;
using Microsoft.Extensions.Options;


namespace EducaOnline.Financeiro.API.Facade
{
    public class PagamentoCartaoCreditoFacade : IPagamentoFacade
    {
        ...
        {
            var nerdsPagSvc = new PagamentoService(_pagamentoConfig.DefaultApiKey,
        ...
        public static Transaction ParaTransaction(Transacao transacao, PagamentoService pagamentoService)
        {
            return new Transaction(pagamentoService)
            {
